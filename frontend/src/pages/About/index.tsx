	...
	return (
		<div className="flex justify-center align-middle">
			<div className=" container m-10 max-w-prose rounded bg-slate-50 p-8 shadow-md">
				...
				{isDev() ? (
					<section className="mt-4 flex flex-row items-center gap-2 border-l-4 border-slate-500 bg-slate-300 p-2 text-slate-800">
						<ExclamationTriangleIcon className="h-8 w-8 text-red-600" />
						<span>
							Frontend currently running in development mode
						</span>
					</section>
				) : undefined}
			</div>
